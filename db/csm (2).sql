...
--
-- Host: localhost
-- Generation Time: Oct 14, 2015 at 11:36 AM
...
INSERT INTO `tbl_clients` (`id`, `name`, `address`, `telphone_number`, `fax_number`, `email`, `contact_person`, `vat_type`) VALUES
(1, 'ryan', 'dabon', '23423423', '234234', 'ds@gmail.com', 'lskdjflkjsdlfkjsldf', 'Vatable'),
(2, 'james', 'james', '309402834', '30903', 'james@gmail.com', 'lskdjf', 'None Vatable');
...
(1, 'jameshwartlopez', 'sdf', 1, 1, '3242342.34', '234234.23', 2342335, '2015-10-13'),
(2, 'jjjja', 'jja', 1, 1, '2342.34', '234234.23', 2342342, '2015-10-13'),
(3, 'DDDD', 'DDD', 1, 1, '32432342.34', '234234.23', 42342, '2015-10-13');
...
INSERT INTO `tbl_stockout` (`id`, `transaction_no`, `product_id`, `quantity`, `client_id`, `terms`, `date`, `discount`, `user_id`, `status`, `type`, `o_return`) VALUES
(1, '000001', 1, 1, 1, 30, '2015-10-13', '232.32', 1, 'unpaid', 'Order', 0),
(2, '000002', 1, 1, 2, 60, '2015-10-14', '0.00', 25, 'unpaid', 'Warranty', 0),
(3, '000003', 1, 1, 1, 30, '2015-10-14', '0.00', 25, 'unpaid', 'Technical Expense', 0),
(4, '000004', 1, 1, 1, 60, '2015-10-14', '0.00', 25, 'paid', 'Stock Transfer', 0),
(5, '000005', 1, 1, 1, 30, '2015-10-14', '0.00', 25, 'unpaid', 'Order', 0),
(6, '000006', 1, 2, 1, 60, '2015-10-14', '0.00', 25, 'hold', 'Order', 0);
...
(1, '000001', 'STOCK OUT', 1, '2015-10-13', 2342341, 1),
(2, '000002', 'STOCK OUT', 1, '2015-10-14', 2342340, 25),
(3, '000003', 'STOCK OUT', 1, '2015-10-14', 2342339, 25),
(4, '000004', 'STOCK OUT', 1, '2015-10-14', 2342338, 25),
(5, '000005', 'STOCK OUT', 1, '2015-10-14', 2342337, 25),
(6, '000006', 'STOCK OUT', 1, '2015-10-14', 2342335, 25);
